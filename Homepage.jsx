...
const Homepage = () => {
  ...
  return (
    <>
        ...
        >
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
              ...
              <div>
                <img className="w-full" src="../src/component/assets/image.png" alt="" />
              </div>
            </div>
          </div>
        </section>
      ...
      {auth && (
        <div
          className="bg-white from-bg-gray-200 to-bg-gray-500 py-8 sm:py-12 lg:py-16"
          style={{
            backgroundImage: `
            repeating-linear-gradient(45deg, rgba(0,0,0,0.05) 0, rgba(0,0,0,0.05) 1px, transparent 1px, transparent 20px),
            repeating-linear-gradient(-45deg, rgba(0,0,0,0.05) 0, rgba(0,0,0,0.05) 1px, transparent 1px, transparent 20px)
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="mt-6 text-4xl font-bold text-gray-900">
              Where AI Meets Learning Languages
            </h2>
            <p className="mt-3 text-xl text-purple-600 font-semibold">
              Practice anytime and anywhere
            </p>
            <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Meet LangBuddy - your intelligent language companion that
              transforms language learning from textbook theory to real-world
              fluency. Whether you're a beginner or advanced learner, LangBuddy
              is here to chat, correct, and celebrate your progress.
            </p>
            <button
