...
const ProfilePage = () => {
    ...
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        userCertificates.push({
          ...
          language:
            certData.language?.replace("_point", "") || certData.language,
  ...
  const viewCertificate = (certificate) => {
    ...
    if (certificate.pdfUrl) {
      ...
      toast.info(
        "Preparing certificate for viewing. Please download it when ready."
      );
      setSelectedCertificate(certificate);
      setShowCertificate(true);
    }
      ...
      >
        <div className="bg-white p-8 rounded-lg max-w-4xl w-full mx-4">
          <div
            ...
            className="relative w-full aspect-[1.4/1] bg-white"
          >
            {/* Yellow background */}
            <div className="absolute inset-0 bg-[#FFD700]">
              ...
              <div className="absolute inset-[40px] bg-white">
                ...
                <div className="relative z-10 p-12 text-center">
                  ...
                  <h2 className="text-5xl font-cursive mb-12">
                    {data?.Name || "Student"}
                  </h2>

                  <p className="text-xl mb-4">
                    has successfully completed the{" "}
                    {selectedCertificate.language} course
                  </p>
                  <p className="text-xl mb-4">
        ...
        <div className="max-w-3xl w-full bg-white rounded-lg shadow-lg p-8">
          ...
          {downloadedCertificates.length > 0 ? (
            ...
            <div className="text-center text-gray-500 mb-8 p-6 bg-gray-50 rounded-lg">
              <p>
                You haven't downloaded any certificates yet. Go to the Pathway
                page to earn and download certificates!
              </p>
            </div>
          )}
