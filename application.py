...
model_config = {
    "model": "deepseek-r1-distill-llama-70b",  # Example model, can be changed to other Groq-supported models
    "temperature": 0.9,
    "max_tokens": 2048,
    "top_p": 1.0,
}
...
def handle_chat(language, greeting):
    ...
    try:
        ...
        ai_reply = response.choices[0].message.content if response.choices else "No response from AI"
